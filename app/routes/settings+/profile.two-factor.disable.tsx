...
export async function action({ context: { storageContext }, request }: ActionFunctionArgs) {
	...
	return redirectWithToast(storageContext.toastSessionStorage, '/settings/profile/two-factor', {
		title: '2FA Disabled',
	...
	return (
		<div className="mx-auto max-w-sm">
			<disable2FAFetcher.Form method="POST">
				<p>Disabling two factor authentication is not recommended. However, if you would like to do so, click here:</p>
				<StatusButton
					variant="destructive"
